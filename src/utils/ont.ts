...
import type { OnuRow } from "../types/ont.js";
...
export function parseOnuTable(raw: string): OnuRow[] {
...
export function findByAuthInfo(rows: OnuRow[], authinfo: string): OnuRow | undefined {
